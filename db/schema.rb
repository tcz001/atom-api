...
ActiveRecord::Schema.define(version: 20160503215651) do
  ...
  create_table "charges", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "prepaid_order_id", limit: 4
  end

  add_index "charges", ["lease_order_id"], name: "index_charges_on_lease_order_id", using: :btree
  add_index "charges", ["prepaid_order_id"], name: "index_charges_on_prepaid_order_id", using: :btree
  ...
  create_table "prepaid_orders", force: :cascade do |t|
    t.string "serial_number", limit: 255
    t.integer "pay_type", limit: 4
    t.integer "status", limit: 4
    t.decimal "total_amount", precision: 9, scale: 2
  ...
  add_index "prepaid_orders", ["user_id"], name: "index_prepaid_orders_on_user_id", using: :btree
  ...
  add_foreign_key "prepaid_orders", "users"
